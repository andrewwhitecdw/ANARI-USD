...
const char ** query_object_types(ANARIDataType type) {
   switch(type) {
      case ANARI_RENDERER:
      {
         static const char *ANARI_RENDERER_subtypes[] = {"default", "hydra", 0};
...
static const void * ANARI_GROUP_usd__timeVarying_light_info(ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   (void)paramType;
   switch(infoName) {
      case 0: // required
         if(infoType == ANARI_BOOL) {
      ...
      case 4: // description
         {
            static const char *description = "Time varying light bit";
            return description;
         }
      case 7: // sourceExtension
         if(infoType == ANARI_STRING) {
...
static const void * ANARI_GROUP_param_info(const char *paramName, ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   switch(param_hash(paramName)) {
      ...
      case 136:
         return ANARI_GROUP_usd__timeVarying_light_info(paramType, infoName, infoType);
      case 102:
...
static const void * ANARI_WORLD_usd__timeVarying_light_info(ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   (void)paramType;
   switch(infoName) {
      case 0: // required
         if(infoType == ANARI_BOOL) {
...
static const void * ANARI_WORLD_param_info(const char *paramName, ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   switch(param_hash(paramName)) {
      ...
      case 136:
         return ANARI_WORLD_usd__timeVarying_light_info(paramType, infoName, infoType);
      case 102:
...
static const void * ANARI_RENDERER_hydra_usd__hydraRendererName_info(ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   (void)paramType;
   switch(infoName) {
      case 0: // required
         if(infoType == ANARI_BOOL) {
...
static const void * ANARI_RENDERER_hydra_param_info(const char *paramName, ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   switch(param_hash(paramName)) {
      case 96:
         return ANARI_RENDERER_hydra_usd__hydraRendererName_info(paramType, infoName, infoType);
      default:
         return nullptr;
   }
}
...
static const void * ANARI_RENDERER_param_info(const char *subtype, const char *paramName, ANARIDataType paramType, int infoName, ANARIDataType infoType) {
   switch(subtype_hash(subtype)) {
      ...
      case 6:
         return ANARI_RENDERER_hydra_param_info(paramName, paramType, infoName, infoType);
      default:
         return nullptr;
   }
}
      ...
      case 9: // parameter
         if(infoType == ANARI_PARAMETER_LIST) {
            static const ANARIParameter parameters[] = {
               ...
               {"usd::timeVarying.light", ANARI_BOOL},
               {"usd::removePrim", ANARI_BOOL},
               {0, ANARI_UNKNOWN}
            };
            return parameters;
...
static const void * ANARI_RENDERER_hydra_info(int infoName, ANARIDataType infoType) {
   switch(infoName) {
      case 4: // description
         {
            static const char *description = "Hydra-based renderer, enables rendering through a Hydra delegate";
            return description;
         }
      case 9: // parameter
         if(infoType == ANARI_PARAMETER_LIST) {
...
static const void * ANARI_RENDERER_info(const char *subtype, int infoName, ANARIDataType infoType) {
   switch(subtype_hash(subtype)) {
      ...
      case 6:
         return ANARI_RENDERER_hydra_info(infoName, infoType);
      default:
         return nullptr;
   }
}
